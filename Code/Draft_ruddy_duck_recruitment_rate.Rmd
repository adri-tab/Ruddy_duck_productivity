---
lang: en-EN
bibliography: C:/Users/Adrien/Dropbox/JabRef/Library_OFB.bib
...
Count data differentiating adult males from other individuals in waterfowl are successfully used in this study to provide estimations of recruitment rates. 

# Accuracy of the counting method

As expected, countalways lower than samples. Variability consistent to the samples as well, but slightly enhanced compared to the raw immature proportion \@ref(fig:sup)
...
A significant change in adult sex ratio would bias the estimation of recruitment rate. Since this measure integrates many bird cohorts, especially if it is a long-living species, updates on this ratio are not necessary on a year based 

# 

# Impact of harvest on recruitment rate



## reparler des notions en introduction

figure 8 -> One said that recruitment rate can increase if harvest because of heterogeneity and density dependence, but it is not what we observe in France, likely because the exploitation is high inhere and consequently impact. 
