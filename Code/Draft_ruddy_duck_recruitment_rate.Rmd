...
# Accuracy of the recruitment rate

As expected, always lower than samples. Variability consistent to the samples as well, but slightly enhanced compared to the raw immature proportion \@ref(fig:sup)
