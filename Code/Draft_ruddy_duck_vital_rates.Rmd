...
We monitored the demography of Ruddy duck populations in both Great-Britain and France thanks to exhaustive counts on the wintering grounds during the period between December 1 and January 31. In addition to these exhaustive counts, censuses that distinguished female-like from male-like individuals were performed on the same period from 2007 to 2012 in Great Britain, which corresponded to a strong decline of the population. In France, the monitoring spread over 1999, 2001-2009, and 2012-2019, which corresponded to a stabilized population size excepted over 2001-2004, for which the population grew rapidly without control effort. During these years, the eradication effort, under control of the authorities in both countries, was also scrupulously recorded.
...
Practically, we used a very conservative prior on the maximum adult survival by setting a uniform distribution on $[0.7; 0.9]$. The lower limit corresponds to the upper range of survival rates observed in literature for species of similar weight, the upper limit corresponds to the range of survival rates of long-life species [@Nichols1997; @Krementz1997; @Buxton2004]. For the maximum growth rate, we rejected Great Britain data before 1972 since the size estimate of this population is noisy below 50 individuals (Figure \@ref(fig:count)). After reaching the threshold of 1000 individuals, the Great Britain population growth observed a strong inflexion whereas no harvest pressure was applied. This observation suggests that a negative density-dependence process might occur beyond 1000 individuals and led to consider only the first sequence of the time series to infer on the maximum growth rate in Great Britain. For the French population, the two sequences without harvest were used, i.e. 1994-1999 and 2001-2004.
...
Harvest strategies differed from Great Britain to France. In Great Britain, harvest occurred in winter, i.e. before the breeding period, whereas it was done mostly in summer in France, i.e. during and after the breeding period. To identify the impact of the two strategies on the population dynamics, we assessed how vital rates responded to the harvest by considering both average drops and variability changes. To complete our understanding on why the Great Britain strategy was more performing on controlling Ruddy ducks, we compared vital rates with and without harvest in light of the underlying average population growth rates. 
...
(ref:count) Evolution of the size of the two Ruddy duck populations; y-axis is on a log-scale
