...
abstract: |
  ...
  **Keywords**: intrinsic growth rate - vital rate - reproductive success - fecundity - sex ratio - age ratio - Oxyura jamaicensis - harvesting
output: 
...
## Validating the "apparent sex ratio" method {#VAL}
...
\end{equation}
```
## Assessing the effects of culling strategies {#HARV}
