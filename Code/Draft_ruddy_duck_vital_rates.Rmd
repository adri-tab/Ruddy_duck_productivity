---
lang: en-EN
bibliography: "`r here::here('Data', 'vital_rates.bib')`"
...
The trends and status of the White-headed duck and Ruddy duck populations used to be determined exclusively by counts. It was therefore difficult to assess the factors impairing the recovery of the former and the effectiveness of the eradication programme for the latter. In particular, counts alone cannot be used to assess the relative impact of changes in adult survival and recruitment rates on population growth rates, which is a prerequisite for identifying limiting factors.
...
Interestingly, delayed dichromatism allows the estimation of adult survival and recruitment/productivity by monitoring the seasonal evolution of the apparent sex ratio and making few and reasonable assumptions (see next section).
...
| $r_{i, t}$            | Recruitment rate, i.e. number of recruits in population $i$ in year $t$ per adult in year $t - 1$     |
...
\setstretch{1}
```{r vital, out.height = "90%", fig.cap = "(ref:vital)"}
...
This work was partly funded by the LIFE Oxyura project (LIFE17 NAT/FR/000942) under the LIFE programme.
...
# Data, scripts, code, and supplementary information availability  {.unnumbered}

Data and scripts are available online: https://doi.org/10.5281/zenodo.11471723; Tableau et al., 2024 
